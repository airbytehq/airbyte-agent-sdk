...
For all authentication options, see the connector's [authentication documentation](https://github.com/airbytehq/airbyte-agent-sdk/blob/main/connectors/klaviyo/AUTH.md).

## API Reference

For the full API reference with parameters and examples, see the connector's [reference documentation](https://github.com/airbytehq/airbyte-agent-sdk/blob/main/connectors/klaviyo/REFERENCE.md).

---

*[Full docs on GitHub](https://github.com/airbytehq/airbyte-agent-sdk/tree/main/connectors/klaviyo)*
