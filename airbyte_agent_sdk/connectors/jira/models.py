...
UsersSearchResult = JiraExecuteResult[list[User]]
...
IssueFieldsSearchResult = JiraExecuteResult[IssueFieldSearchResults]
"""Result type for issue_fields.search operation."""
