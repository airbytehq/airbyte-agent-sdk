                ...
                Action.GET: EndpointDefinition(
                    ...
                    response_schema={
                        ...
                        'x-airbyte-ai-hints': {
                            ...
                            'when_to_use': 'Looking for emails, searching inbox, or finding specific messages',
                            'trigger_phrases': [
                                'email',
                                'gmail message',
                                'inbox',
                            ...
                            'freshness': 'live',
                            'example_questions': ['Find emails from a specific sender', 'Show unread messages'],
                            'search_strategy': 'Search by subject, sender, or keywords in the body. Use snippet for message previews, payload.headers[].value for headers such as From/To/Subject/Date, and payload.body.data or payload.parts[].body.data for body content when available.',
                        },
                    },
                    record_extractor='$',
                ),
                ...
                Action.GET: EndpointDefinition(
                    ...
                    response_schema={
                        ...
                        'x-airbyte-ai-hints': {
                            ...
                            'when_to_use': 'Looking at email conversations or thread history',
                            'trigger_phrases': ['email thread', 'conversation', 'email chain'],
                            'freshness': 'live',
                            'example_questions': ['Show the email thread about a topic', 'Find conversations with a person'],
                            'search_strategy': 'Search by subject or participant',
                        },
                    },
                    record_extractor='$',
                ),
