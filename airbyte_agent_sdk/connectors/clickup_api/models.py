...
class TasksSearchResultMeta(BaseModel):
...
TasksSearchResult = ClickupApiExecuteResultWithMeta[list[Task], TasksSearchResultMeta]
"""Result type for tasks.search operation with data and metadata."""
