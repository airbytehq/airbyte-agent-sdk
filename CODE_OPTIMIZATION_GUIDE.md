# 代码优化指南 - airbytehq/airbyte-agent-connectors

## 🎯 项目信息
- **项目**: airbytehq/airbyte-agent-connectors
- **描述**: 🐙 Drop-in tools that give AI agents reliable, permission-aware access to external systems.
- **星标**: 107 ⭐
- **语言**: Python
- **生成时间**: 2026-02-25 11:31:13
